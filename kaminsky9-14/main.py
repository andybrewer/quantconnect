...
class HolyGrailProject(QCAlgorithm):
    ...
    def initialize(self):
        ...
        self.target_leverage = getattr(algorithm_parameters, "target_leverage", 3.53)  # e.g., 3×
    ...
    def execute_specific_trade_decider(
            ...
            **kwargs,
            ...
            target_leverage = float(getattr(self, "target_leverage", 3.53))
                ...
                if (
                    ...
                    if trading_decision.decision_type not in [
                        ...
                        if futures_trading_parameters.is_trading_futures:
                            ...
                            self.debug(f"Waiting {ACCOUNT_DELAY_SECONDS} seconds before sending equity market order")
